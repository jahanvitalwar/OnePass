...
def mainPasswordKeeper(username):
    ...
    def add():
        ...
        try:
            ...
            add_new.iconbitmap("Images/jahanvilogo.ico")
            width2 = 500
            height2 = 600
    ...
    def search():
        top = Toplevel()
        top.title("Search...")
        top.iconbitmap("Images/jahanvilogo.ico")
    ...
    def edit():
        ...
        def edit_record():
            ...
            if id_entry.get() == "":
                ...
                edit_new.iconbitmap("Images/jahanvilogo.ico")
                width3 = 500
                height3 = 600
    ...
    def delete():
        ...
        delete_record.iconbitmap("Images/jahanvilogo.ico")
        width2 = 350
        height2 = 300
    ...
    def exit_program():
        ...
        '''bye = Tk()
        bye.title("BYE!")
        bye.iconbitmap("Images/jahanvilogo.ico")
        width = 500
        height = 530
        ...
        my_img = ImageTk.PhotoImage(Image.open("Images/jahanvilogo.jpg"))
        ...
        bye.mainloop()
        os.system('notepad Images/about.txt')'''
